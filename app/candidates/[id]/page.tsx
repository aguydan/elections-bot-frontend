...
export default async function Page({ params }: { params: { id: string } }) {
  ...
  return (
    <Stack>
      <Group p="3.5rem 3.5rem 0" align="flex-start" gap="xl">
        <CoverImage
          w="12rem"
          h="16rem"
        ...
        <Stack flex={1} gap="xs">
          <Group pos="relative">
            ...
            />
            <GradientDecoration angle={4} mt={22}>
              <Title fw="800" fz="2.2rem" c="black" order={2}>
                {candidate.name}
              </Title>
            </GradientDecoration>
          </Group>
      ...
      <GradientDecoration angle={1} m="0 3.5rem 2.5rem">
